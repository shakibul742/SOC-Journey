...
| Type | Event ID / Case | Alert Name | Summary | Report Link |
| --- | --- | --- | --- | --- |
...
| LFI | **SOC170** | Passwd Found in Requested URL - Possible LFI Attack | Investigated a SIEM alert for a possible LFI attack involving a passwd file requested in a URL. | [SOC170 Report](LFI-RFI/SOC170%20-Possible-LFI-Attack.md) |
